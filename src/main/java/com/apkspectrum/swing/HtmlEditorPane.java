...
public class HtmlEditorPane extends JEditorPane implements HyperlinkListener {
    ...
    public HtmlEditorPane(String head, String style, String body) {
        ...
        getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_T, _RConst.CTRL_MASK), "none");
        getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_T, _RConst.CTRL_SHIFT_MASK), "none");
    ...
    private static String makeHtml(String head, String body) {
        return head != null ? "<html><head>" + head + "</head><body>" + body + "</body></html>"
                : body;
    }
        ...
        if (e.getEventType().equals(HyperlinkEvent.EventType.ACTIVATED)) {
            ...
            if (!e.getDescription().startsWith("@")) {
                ...
                if (elem != null) {
                    ...
                    if (a != null) {
                        invokeEvent(new HyperlinkClickEvent(
                                (String) a.getAttribute(HTML.Attribute.ID)));
                    }
                }
            }
            ...
            if (elem != null) {
                ...
                if (a != null && a.getAttribute(HTML.Attribute.TITLE) != null) {
                    String htmlToolTip =
                            "<html><body>" + ((String) a.getAttribute(HTML.Attribute.TITLE))
                                    .replaceAll("\n", "<br/>") + "</body></html>";
    ...
    public static String makeHyperLink(String href, String text, String title, String id,
            String style) {
        String attr = "";
        if (title != null) {
    ...
    public String makeHyperLink(String href, String text, String title, String id, String style,
            Object userData) {
    ...
    // refer to
    // https://stackoverflow.com/questions/46023177/set-inline-text-and-image-in-a-jeditorpane
